<section id="artikel">
    ...
    <div id="form">
   			 <div class="panel panel-info">
  			<div class="panel-heading">
    		<h3 class="panel-title">Form Data Artikel</h3>
  			</div>
  			<div class="panel-body">
              ...
              <div class="form-group">
                <label for="isiartikel" class="col-sm-2 control-label">Isi Artikel</label>
                <div class="col-sm-10">
...
<script src="halaman/artikel/artikel_script.js"></script>